...
@section('content')
    ...
    <div class="content">
        <h2 class="subTitletext" >
            <?php
            if($type=='p'){
            echo "Interact partner: ",$partner_name;}
            else{
            echo "LncRNA: ",$partner_name; }
           ?>
         </h2>
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                ...
                @foreach($list2 as $tmp)
                    @endforeach
                    <dt>Gene Symbol:</dt><dd>{{$tmp->symbol}}</dd>
                    @if($tmp->alias!="-")
                        <dt>Alias:</dt>
                ...
                @endif
                @if($interactant_id==0)
                        {{$partner_name}} gene hasn't been annotated in NCBI until May 4th,2015.
                    @endif
                </div>
            </div>
        ...
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <div id="cytoscapeweb" style="width:1000px;height:350px;margin:20px auto">
                </div>
            </div>
        </div>
        <script type="text/javascript">
            ...
            foreach($vertexes2 as $tmp=>$each)
            {
                ...
                $edge=array('id'=>"$vertexes5[$tmp]",'source'=>"$tmp",'target'=>"$each");
...
//              value="RNY19606l";
//              var bypass = { nodes: {
//                  RNY19606l: { color: "red", opacity: 0.5, size: 32 }
//              }}
        ...
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <<div class="col-md-8">Total amount:{{$count}}</div>
                            <div class="col-md-3">
                                ...
                                <input type="hidden" name="lncr_name" id="lncr_name" value="{{$partner_name}}">
                                <input type="hidden" name="gene_id" id="lncr_name" value="{{$interactant_id}}">
                ...
                <table class="table-bordered  table-hover tablesorter" style="color:black;height: auto">
                    <thead>
                ...
                <div id="bottom">
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="holder" style="margin-left: 0px"></div>
                        </div>
                        <div class="col-xs-6">
                            <table class="TotalText">
                                ...
                                <th width="100px">
                                    ...
                                    <input type="hidden" name="interactant" id="interactant" value="{{$partner_name}}">
        ...
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <dl class="dl-horizontal">
                        <?php $arr1= explode("|","$linkout"); $arr1=array_unique($arr1);?>
                        @foreach($arr1 as $each=>$linkout)
                            <?php
                            ...
                            @foreach($arr2 as $each=>$value)
                                    ...
                                    @endif
                                        @if($each=='SGD')
                                            <dt>SGO ID:</dt><dd><a href="http://www.yeastgenome.org/cgi-bin/locus.fpl?sgdid={{$value}}" target="_blank"> {{$value}}</a></dd>
                                        @endif
                                @if($each=='Ensembl')
