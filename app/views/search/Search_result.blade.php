...
@section('content')
    ...
    <div class="content">
        <div class="row" id="search">
            <h2 class="subTitletext">Search results</h2>
                        ...
                        <div class="col-xs-6">
                            <table class="TotalText">
                                ...
                                <th width="120px">
                                    ...
                                    <input type="hidden" name="organism" id="organism" value="{{$organism}}">
                                    <input type="hidden" name="interactant" id="interactant" value="{{$interactant}}">
