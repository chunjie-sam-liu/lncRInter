...
@section('content')
    ...
    <div class="content">
        <h2 class="subTitletext">Browse by <?php
            if($species)
                {echo $species;}
                elseif($class)
                {echo $class;}
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <table class="TotalText">
                                    <thead>
                                    <th width="160px"></th>
                                    <th width="180px">Total amount:{{count($searchresult)}}</th>
                                    <th width="120px">
                                        {{Form::open(array('url'=>'/CreateTxtFile','class'=>'form-horizontal','method'=>'get'))}}
                                        <input type="hidden" name="name" id="name" value="">
                                        <input type="hidden" name="organism" id="organism" value="{{$species}}">
            ...
            @endforeach
                        ...
                        <script type="text/javascript">
                            $(document).ready(function(){
                                var count = "<?php echo count($searchresult); ?>";
                                if(count<10)
                                    $("#bottom").hide();
                                else $("#bottom").show();
                            });
